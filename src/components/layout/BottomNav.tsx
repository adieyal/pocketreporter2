...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-16 bg-white border-t border-gray-200 pb-safe z-50">
      <div className="flex items-center justify-around h-full max-w-md mx-auto">
        ...
        <NavLink to="/create" className={navItemClass}>
          <div className="bg-brand text-white p-2 rounded-full -mt-6 shadow-lg border-4 border-gray-50">
            <Plus size={24} />
          </div>
