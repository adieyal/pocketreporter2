...
export function HelpPage() {
  return (
    <div className="pb-20">
      <header className="sticky top-0 bg-white border-b border-gray-200 z-10 px-4 py-3 flex items-center gap-3">
      ...
      <div className="p-4 space-y-6 max-w-md mx-auto">
        ...
        {/* Quick Tips */}
        <section>
          <h2 className="text-sm font-bold text-gray-400 uppercase tracking-wide mb-3">Quick Tips</h2>
        ...
        {/* FAQ Accordion */}
        <section>
          <h2 className="text-sm font-bold text-gray-400 uppercase tracking-wide mb-3">Frequently Asked Questions</h2>
...
function HelpCard({ icon, title, text }: { icon: React.ReactNode, title: string, text: string }) {
  return (
    <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex gap-4">
      <div className="text-brand bg-brand-light h-10 w-10 rounded-lg flex items-center justify-center shrink-0">
        {icon}
      </div>
      <div>
...
function FaqItem({ q, a }: { q: string, a: string }) {
  return (
    <details className="group p-4 open:bg-gray-50 transition-colors">
      <summary className="flex justify-between items-center font-medium cursor-pointer list-none text-gray-900">
        {q}
